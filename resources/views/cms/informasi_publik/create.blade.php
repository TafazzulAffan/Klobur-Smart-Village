...
@section('title', 'Tambah Data Informasi Publik')

@section('header')
<h2 class="font-bold text-lg">Tambah Data Informasi Publik</h2>
@endsection

@section('content')
<div class="p-8 shadow-xl">
    <form method="POST" action="{{route('simpan.publik')}}" enctype="multipart/form-data">
        @csrf
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="judul-informasi" class="block mb-2 text-sm font-medium text-gray-900">Judul Informasi Publik</label>
                <input type="text" name="judul" id="judul-informasi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full p-2.5" placeholder="Masukkan Judul Informasi Publik" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input name="upload_berkas" type="file" id="upload-berkas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full">
            </div>
        </div>
