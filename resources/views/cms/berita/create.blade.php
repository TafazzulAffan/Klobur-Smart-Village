...
@section('header')
    <h2 class="font-bold text-lg">Tambah Berita Desa</h2>
@endsection

@section('content')
    <div class="p-8 shadow-xl">
        <form method="POST" action="{{ route('berita.simpan') }}" enctype="multipart/form-data">
            @csrf
            <div class="flex flex-col gap-6 w-3/4 mx-auto">
                <div>
                    ...
                    <img id="imagePreview" src="{{ asset('img/gambar.png') }}" alt=""
                        class="w-96 mx-auto mb-5 rounded-lg">
                    <input type="file" id="thumbnail" name="gambar"
                ...
                <div>
                    ...
                    <select id="status-berita" name="status"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full p-2.5">
                        <option selected>Pilih Status Berita</option>
                ...
                <div>
                    ...
                    <textarea id="slug" name="slug" rows="3"
                        ...
                        placeholder="Masukkan Isi Singkat Berita"></textarea>
                    <label for="slug" class="block mt-2 text-sm text-gray-900">Isi Maksimal 15 kata</label>
                </div>
                <div>
                    <label for="konten" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Isi
                        Berita</label>
