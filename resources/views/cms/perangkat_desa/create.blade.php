...
@section('header')
    <h2 class="font-bold text-lg">Tambah Data Perangkat Desa</h2>
@endsection
    ...
    <div class="p-8 shadow-xl">
        <form method="POST" action="{{ route('perangkat.store') }}" enctype="multipart/form-data">
            ...
            <div class="relative mb-6 w-fit">
                <img id="imagePreview" class="w-28 h-28 object-cover rounded-full" src="{{ asset('img/profile.png') }}" alt="">
                <label for="foto"
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select id="status" name="status"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full p-2.5">
                        <option selected>Pilih Status Perangkat</option>
