...
@section('title', 'Surat Tercetak Hari Ini')
...
@section('header')
<p class="text-sm md:text-base"><span class="text-green">Layanan <span class="text-black">/</span> <a href="/kelola-perizinan">Perizinan Online</a></span> / Surat Tercetak Hari Ini</p>
