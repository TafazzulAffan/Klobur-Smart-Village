...
@section('title', 'Surat Tercetak Tahun Ini')
...
@section('header')
<p class="text-sm md:text-base"><span class="text-green">Layanan <span class="text-black">/</span> <a href="/kelola-perizinan">Perizinan Online</a></span> / Surat Tercetak Tahun Ini</p>
