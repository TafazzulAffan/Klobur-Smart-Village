...
<p class="text-sm md:text-base">
    <a href="/"><span class="text-green">Kelola APBDes</span></a>
</p>
<div class="flex items-center gap-5 justify-end">

    {{--   <button type="button" onclick="window.location.href='/tambah-anggaran-realisasi-pendapatan'" class="flex items-center gap-3 text-white bg-green-500 hover:bg-green-600 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg px-4 py-2 text-center mr-3 md:mr-0 text-lg">
...
<div x-data="{ 
    ...
    {{-- <div class="flex justify-between"> --}}
        ...
        <ul class="flex flex-wrap -mb-px font-medium text-center text-gray-500 dark:text-gray-400">
            <li class="mr-2">
                <a href="#pendapatan" x-on:click="activeTab = 1" :class="activeTab === 1 ? activeClass : inactiveClass" class="inline-flex gap-2 items-center justify-center py-2 px-4 border-b-2 rounded-t-lg">
                    <svg x-on:click="activeTab = 1" :class="activeTab === 1 ? activeClass : inactiveClass" class="w-5 h-5 text-gray-green hover:text-green group-hover:text-green" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
            ...
            <li class="mr-2"> 
                <a href="#belanja" x-on:click="activeTab = 2" :class="activeTab === 2 ? activeClass : inactiveClass" class="inline-flex gap-2 items-center justify-center py-2 px-4 border-b-2 rounded-t-lg">
                    <svg x-on:click="activeTab = 2" :class="activeTab === 2 ? activeClass : inactiveClass" class="w-5 h-5 text-gray-green hover:text-green group-hover:text-green" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
            ...
            <li class="mr-2"> 
                <a href="#pembiayaan" x-on:click="activeTab = 3" :class="activeTab === 3 ? activeClass : inactiveClass" class="inline-flex gap-2 items-center justify-center py-2 px-4 border-b-2 rounded-t-lg">
                    <svg x-on:click="activeTab = 3" :class="activeTab === 3 ? activeClass : inactiveClass" class="w-5 h-5 text-gray-green hover:text-green group-hover:text-green" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li class="mr-2"> 
                <a href="#laporan" x-on:click="activeTab = 4" :class="activeTab === 4 ? activeClass : inactiveClass" class="inline-flex gap-2 items-center justify-center py-2 px-4 border-b-2 rounded-t-lg">
                    <svg x-on:click="activeTab = 4" :class="activeTab === 4 ? activeClass : inactiveClass" class="w-5 h-5 text-gray-green hover:text-green group-hover:text-green" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
            ...
            <li class="mr-2"> 
                <a href="#grafik" x-on:click="activeTab = 5" :class="activeTab === 5 ? activeClass : inactiveClass" class="inline-flex gap-2 items-center justify-center py-2 px-4 border-b-2 rounded-t-lg">
                    <svg x-on:click="activeTab = 5" :class="activeTab === 5 ? activeClass : inactiveClass" class="w-5 h-5 text-gray-green hover:text-green group-hover:text-green" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
    ...
    <div class="mt-6">
        ...
        <div x-show="activeTab === 1">
            <div class="relative overflow-x-auto">
                <div class="flex items-center gap-5 mb-5 justify-end p-1">
                    <button type="button" onclick="window.location.href='/tambah-pendapatan'" class="flex items-center gap-3 text-white bg-green-500 hover:bg-green-600 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg px-4 py-2 text-center mr-3 md:mr-0 text-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 16 16" fill="none">
                            <path d="M8 0C8.55228 0 9 0.447715 9 1V7H15C15.5523 7 16 7.44772 16 8C16 8.55228 15.5523 9 15 9H9V15C9 15.5523 8.55228 16 8 16C7.44772 16 7 15.5523 7 15V9H1C0.447715 9 0 8.55228 0 8C0 7.44772 0.447715 7 1 7H7V1C7 0.447715 7.44772 0 8 0Z" fill="#F8F9FA"/>
                            <path d="M2.5 8H13.5M8 2.5L8 13.5" stroke="#F8F9FA" stroke-linecap="round" stroke-linejoin="round"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.27614 2 8.5 2.22386 8.5 2.5V7.5H13.5C13.7761 7.5 14 7.72386 14 8C14 8.27614 13.7761 8.5 13.5 8.5H8.5V13.5C8.5 13.7761 8.27614 14 8 14C7.72386 14 7.5 13.7761 7.5 13.5V8.5H2.5C2.22386 8.5 2 8.27614 2 8C2 7.72386 2.22386 7.5 2.5 7.5H7.5V2.5C7.5 2.22386 7.72386 2 8 2Z" fill="#F8F9FA"/>
...
@endphp          
                    ...
                    <tbody class="text-left">
                        <tr class="bg-white border-b">
                            <td class="px-1 py-4 border-r flex justify-center gap-3 box-content my-auto">
                                    <a href="/hapus-pendp/{{ $anggaranpendp->id }}">
                                    <img class="bg-red-500 hover:bg-red-700 w-4 h-4 box-content p-2 rounded" src="{{asset('icon/delete.svg')}}" alt="">
                                    </a>
                                <a href="/tambah-pendapatan/{{$anggaranpendp->id}}/edit" >
                                    {{-- type="button" onclick="window.location.href='{{ route('anggaran-realisasi.edit') }}'" --}}
        ...
        <div x-show="activeTab === 2">
            <div class="relative overflow-x-auto">
                <div class="flex items-center gap-5 mb-5 justify-end p-1">
                    <button type="button" onclick="window.location.href='/tambah-belanja'" class="flex items-center gap-3 text-white bg-green-500 hover:bg-green-600 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg px-4 py-2 text-center mr-3 md:mr-0 text-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 16 16" fill="none">
                            <path d="M8 0C8.55228 0 9 0.447715 9 1V7H15C15.5523 7 16 7.44772 16 8C16 8.55228 15.5523 9 15 9H9V15C9 15.5523 8.55228 16 8 16C7.44772 16 7 15.5523 7 15V9H1C0.447715 9 0 8.55228 0 8C0 7.44772 0.447715 7 1 7H7V1C7 0.447715 7.44772 0 8 0Z" fill="#F8F9FA"/>
                            <path d="M2.5 8H13.5M8 2.5L8 13.5" stroke="#F8F9FA" stroke-linecap="round" stroke-linejoin="round"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.27614 2 8.5 2.22386 8.5 2.5V7.5H13.5C13.7761 7.5 14 7.72386 14 8C14 8.27614 13.7761 8.5 13.5 8.5H8.5V13.5C8.5 13.7761 8.27614 14 8 14C7.72386 14 7.5 13.7761 7.5 13.5V8.5H2.5C2.22386 8.5 2 8.27614 2 8C2 7.72386 2.22386 7.5 2.5 7.5H7.5V2.5C7.5 2.22386 7.72386 2 8 2Z" fill="#F8F9FA"/>
                ...
                <table class="w-full text-sm text-abu-700 border">
                    ...
                    <tbody class="text-left">
                        <tr class="bg-white border-b">
                            <td class="px-1 py-4 border-r flex justify-center gap-3 box-content my-auto">
                                <a href="/hapus-belj/{{ $anggaranbel->id }}">
                                    <img class="bg-red-500 hover:bg-red-700 w-4 h-4 box-content p-2 rounded" src="{{asset('icon/delete.svg')}}" alt="">
                                </a>
                                <a href="/tambah-belanja/{{$anggaranbel->id}}/edit" >
                                    <img class="bg-green-500 hover:bg-green-700 w-4 h-4 box-content p-2 rounded" src="{{asset('icon/edit.svg')}}" alt="">
                                </a>
                            </td>
                            <td class="px-3 py-4 border-r whitespace-nowrap">
        ...
        <div x-show="activeTab === 3">
            <div class="relative overflow-x-auto">
                <div class="flex items-center gap-5 mb-5 justify-end p-1">
                    <button type="button" onclick="window.location.href='/tambah-pembiayaan'" class="flex items-center gap-3 text-white bg-green-500 hover:bg-green-600 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg px-4 py-2 text-center mr-3 md:mr-0 text-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 16 16" fill="none">
                            <path d="M8 0C8.55228 0 9 0.447715 9 1V7H15C15.5523 7 16 7.44772 16 8C16 8.55228 15.5523 9 15 9H9V15C9 15.5523 8.55228 16 8 16C7.44772 16 7 15.5523 7 15V9H1C0.447715 9 0 8.55228 0 8C0 7.44772 0.447715 7 1 7H7V1C7 0.447715 7.44772 0 8 0Z" fill="#F8F9FA"/>
                            <path d="M2.5 8H13.5M8 2.5L8 13.5" stroke="#F8F9FA" stroke-linecap="round" stroke-linejoin="round"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.27614 2 8.5 2.22386 8.5 2.5V7.5H13.5C13.7761 7.5 14 7.72386 14 8C14 8.27614 13.7761 8.5 13.5 8.5H8.5V13.5C8.5 13.7761 8.27614 14 8 14C7.72386 14 7.5 13.7761 7.5 13.5V8.5H2.5C2.22386 8.5 2 8.27614 2 8C2 7.72386 2.22386 7.5 2.5 7.5H7.5V2.5C7.5 2.22386 7.72386 2 8 2Z" fill="#F8F9FA"/>
                ...
                <table class="w-full text-sm text-abu-700 border">
                    ...
                    @php
                        $nobiaya=1;
                    @endphp
                    @foreach($anggaranbiaya as $anggaranbiaya)
                    <tbody class="text-left">
                        <tr class="bg-white border-b">
                            <td class="px-1 py-4 border-r flex justify-center gap-3 box-content my-auto">
                                <a href="/hapus-biaya/{{ $anggaranbiaya->id }}">
                                    <img class="bg-red-500 hover:bg-red-700 w-4 h-4 box-content p-2 rounded" src="{{asset('icon/delete.svg')}}" alt="">
                                </a>
                                <a href="/tambah-pembiayaan/{{ $anggaranbiaya->id }}/edit">
                                    <img class="bg-green-500 hover:bg-green-700 w-4 h-4 box-content p-2 rounded" src="{{asset('icon/edit.svg')}}" alt="">
                                </button>
                            </td>
                            <td class="px-3 py-4 border-r whitespace-nowrap">
                            ...
                            <th scope="row" class="px-6 py-4 border-r font-medium">
                                {{$anggaranbiaya->rincian}}
                            </th>
                            <td class="px-6 py-4 border-r whitespace-nowrap">
                                <span>Rp </span>{{$anggaranbiaya->nilai_anggaran}}
                            </td>
                            <td class="px-6 py-4 border-r whitespace-nowrap">
                                <span>Rp </span>{{$anggaranbiaya->nilai_realisasi}}
                            </td>
                            <td class="px-6 py-4 border-r whitespace-nowrap">
                                {{$anggaranbiaya->created_at}}
                            </td>
                            <td class="px-6 py-4 border-r whitespace-nowrap">
                                {{$anggaranbiaya->updated_at}}
                            </td>
                        </tr>
                    </tbody>
                    @endforeach
        ...
        <div x-show="activeTab === 4">
            @include('cms.anggaran-realisasi.components.laporan')
        </div>
        {{-- Content Laporan End --}}

        {{-- Content Grafik Start --}}
        <div x-show="activeTab === 5">
            @include('cms.anggaran-realisasi.components.grafik')
        </div>
        {{-- Content Grafik End --}}
    </div>
    {{-- Tab Content End --}}
