...
@section('header')
<h2 class="font-bold text-lg">Tambah Data APBDes Pendapatan</h2>
@endsection

@section('content')
<div class="p-8 shadow-xl">
    <form method="POST" action="{{ route('store.pendp') }}" enctype="multipart/form-data">
        @csrf
        <div class="flex flex-col gap-6 w-3/4 mx-auto">
            ...
            <div>
                ...
                <select name="detail_jenis_anggaran" id="detail-anggaran" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full p-2.5">
                    ...
                    <option value="Pendapatan Asli Desa">1.1 Pendapatan Asli Desa</option>
                    <option value="Pendapatan Transfer">1.2 Pendapatan Transfer</option>
                    <option value="Pendapatan Lain-Lain">1.3 Pendapatan Lain-Lain</option>
                </select>
            </div>
            <div>
                <label for="anggaran" class="block mb-2 text-sm font-medium text-gray-900">Nilai Anggaran</label>
                <input type="text" name="nilai_anggaran" id="anggaran" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full p-2.5" placeholder="Masukkan Nilai Anggaran" required>
            ...
            <div>
                ...
                <input type="text" name="nilai_realisasi" id="realisasi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full p-2.5" placeholder="Masukkan Nilai Realisasi" required>
            ...
            <div>  
                ...
                <textarea name="rincian" id="keterangan" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green focus:border-green" placeholder="Masukkan Keterangan"></textarea>
            </div>
