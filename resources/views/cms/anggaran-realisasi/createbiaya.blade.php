...
@section('header')
<h2 class="font-bold text-lg">Tambah Data APBDes Pembiayaan</h2> 
@endsection

@section('content')
<div class="p-8 shadow-xl">
    <form action="{{route('store.biaya')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="flex flex-col gap-6 w-3/4 mx-auto">
            ...
            <div>
                ...
                <select name="detail_jenis_anggaran" id="detail-anggaran" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-green block w-full p-2.5">
                    ...
                    <option value="Penerimaan Pembiayaan">1 Penerimaan Pembiayaan</option>
                    <option value="Pengeluaran Pembiayaan">2 Pengeluaran Pembiayaan</option>
                </select>
            </div>
            <div>
