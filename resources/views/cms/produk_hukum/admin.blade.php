...
<p class="text-sm md:text-base">
    <a href="/"><span class="text-green">Regulasi</span></a> / Produk Hukum</p>
<div class="flex items-center gap-5 justify-end">
    <!-- Search Start -->
    <form class="w-72" action="/kelola-hukum" method="GET">   
        ...
        <div class="relative">
            ...
            <input type="search" name="search" id="default-search" class="block w-full px-4 py-3 pr-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green-500 focus:border-green-500" placeholder="Cari judul produk hukum" required>
        </div>
    </form>
    <!-- Search End -->

    <button type="button" onclick="window.location.href='/tambah-hukum'" class="flex items-center gap-3 text-white bg-green-500 hover:bg-green-600 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg px-4 py-2 text-center mr-3 md:mr-0 text-lg">
