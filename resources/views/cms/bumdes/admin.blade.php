...
@section('header')
<p class="text-sm md:text-base"><span class="text-green">Layanan</span> / BUMDes</p>
<div class="flex items-center gap-5 justify-end">
    ...
    <form class="w-72">   
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full px-4 py-3 pr-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green-500 focus:border-green-500" placeholder="Cari judul bumdes" required>
        </div>
    </form>
    <!-- Search End -->

    <button type="button" onclick="window.location.href='/tambah-bumdes'" class="flex items-center gap-3 text-white bg-green hover:bg-green-600 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg px-4 py-2 text-center mr-3 md:mr-0 text-lg" style="background: green;">
        ...
        <tbody class="text-left">
            <tr class="bg-white border-b">
                ...
                <td class="px-6 py-4 border-r">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur eos, incidunt quo maiores laudantium suscipit minus voluptate
                </td>
