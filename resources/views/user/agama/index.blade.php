...
@section('title', 'Website Resmi Pemerintah Desa Klobur - Data Agama')
...
@section('header')
    <div class="">
        <a href="/"><p class="text-sm md:text-base"><span class="text-[#198754]">Data Desa</span></a> > Data Agama</p>
        <h3 class="font-bold text-xl md:text-3xl mt-2">Data Agama</h3>
    </div>
@endsection
...
@section('script')
    <script>
        ...
        var agamaX = JSON.parse('{!! json_encode($grafikAgama) !!}')
        // Define Chart Agama Start

        // Chart Agama Pie Start
        new Chart(agama, {
            type: "pie",
            data: {
                labels: ["Islam", "Kristen", "Khatolik", "Budha", "Hindu", "Khonghucu", "Lainnya"],
                datasets: [{
                    data: agamaX,
                    borderWidth: 1,
                }, ],
