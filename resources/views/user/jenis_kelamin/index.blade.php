...
@section('title', 'Website Resmi Pemerintah Desa Klobur - Data Jenis Kelamin')
...
@section('header')
    <div class="">
        <a href="/"><p class="text-sm md:text-base"><span class="text-[#198754]">Data Desa</span></a> > Data Jenis Kelamin</p>
        <h3 class="font-bold text-xl md:text-3xl mt-2">Data Jenis Kelamin</h3>
    </div>
@endsection
        ...
        <div x-data="{
            ...
            <div class="flex justify-center">
                <ul class="flex flex-wrap -mb-px font-medium text-center text-gray-500 dark:text-gray-400">
                    <li class="mr-2">
                        <a href="#grafik-agama" x-on:click="activeTab = 1"
                    ...
                    <li class="mr-2">
                        <a href="#grafik-agama" x-on:click="activeTab = 2"
            ...
            <div>
                {{-- Pie Start --}}
                <div id="grafik-agama" x-show="activeTab === 1" class="py-5 w-full md:w-3/5 mx-auto">
                    <canvas id="chart-gender"></canvas>
                </div>
                {{-- Pie End --}}

                {{-- Bar Start --}}
                <div id="grafik-agama" x-show="activeTab === 2" class="py-5 w-full md:w-4/5 mx-auto">
                    <canvas id="chart-gender-bar"></canvas>
                </div>
                {{-- Bar End --}}
            </div>
            {{-- Tab Content End --}}
    ...
    <div class="relative overflow-x-auto mt-jarak">
        <table class="w-full text-sm text-abu-700 border">
            ...
            <tbody class="text-left">
                ...
                <tr class="bg-white border-b">
                    <th colspan="2" scope="row" class="px-6 py-4 border-r font-bold text-center whitespace-nowrap">
                        Jumlah
                    </th>
...
@section('script')
    <script>
        ...
        var jenisKelaminX = JSON.parse('{!! json_encode($jenisKelamins) !!}')
